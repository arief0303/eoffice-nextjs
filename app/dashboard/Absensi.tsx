    ...
    return (
        <>
            <div className="h-24 flex items-center justify-center">
                ...
                {/* </button> */}
                <div className="w-screen text-center text-gray-800 text-base font-bold font-['Montserrat']">Absensi</div>
            </div>
            <div className='flex flex-col items-center'>
                <div className="w-[374px] h-12 p-3 bg-neutral-100 rounded-lg border justify-between items-center inline-flex">
                    <div className="text-slate-500 text-base font-normal font-['Montserrat'] tracking-tight">Pilih Bulan</div>
                ...
                <div className='flex flex-col items-center mt-8'>
                    <div className="w-[374px] h-12 justify-between items-center inline-flex">
                        <div className="justify-start items-center gap-3.5 flex">
                            ...
                            <div className="flex-col justify-start items-start gap-2 inline-flex">
                                <div className="text-zinc-800 text-base font-semibold font-['Montserrat'] tracking-tight">07 : 53 : 50  WIB</div>
                                <div className="text-stone-500 text-opacity-90 text-xs font-normal font-['Montserrat'] tracking-tight">12 Nov 2020</div>
                            </div>
                        </div>
                        <div className="flex-col justify-start items-end gap-2 inline-flex">
                            <div className="text-primary text-right text-slate-500 text-base font-medium font-['Montserrat'] tracking-tight">Tepat Waktu</div>
                    ...
                    <div className="mt-6 w-[374px] h-12 justify-between items-center inline-flex">
                        ...
                        <div className="flex-col justify-start items-end gap-2 inline-flex">
                            <div className="text-right text-red text-base font-medium font-['Montserrat'] tracking-tight">Terlambat</div>
                            <div className="text-stone-500 text-opacity-90 text-xs font-normal font-['Montserrat'] tracking-tight">Shift pagi</div>
                        </div>
                    </div>
                </div>
