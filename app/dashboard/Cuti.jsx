...
const Cuti = () => {
    ...
    return (<>
        <div className="h-24 flex items-center justify-center">
            ...
            <div className="w-screen text-center text-gray-800 text-base font-bold font-['Montserrat']">Cuti</div>
        </div>
        <div className="w-[374px] h-12 bg-slate-500 rounded-[10px] border inline-flex justify-start ">
            ...
            <div className="text-white text-base font-medium font-['Montserrat']">Ajukan Cuti</div>
        </div>
        <div class="w-[374px] h-12 p-3 bg-neutral-100 rounded-lg border justify-between items-center inline-flex">
            {/* <div class="text-slate-500 text-base font-normal font-['Montserrat'] tracking-tight">Ajukan Cuti</div>
